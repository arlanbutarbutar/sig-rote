<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color: #7ab730;">
    <div class="me-3">
    ...
    <div>
      <a class="navbar-brand brand-logo d-flex" href="./">
        <img src="../assets/images/logo.png" alt="" style="width: 60px;height: 60px;">
        <h1 class="my-auto" style="font-size: 25px;color: #fff;font-weight: bold;text-align: left;margin-left: 10px;">Rote <br>Ndao</h1>
      </a>
  ...
  <div class="navbar-menu-wrapper d-flex align-items-top shadow">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        ...
        <p class="">
          ...
          <?php if ($_SESSION['page-url'] == "lokasi?id=" . $_GET['id']) { ?>
            / <a href="wisata" class="text-decoration-none text-dark">Wisata</a>
          <?php }
          if ($_SESSION['page-url'] == "galeri?id=" . $_GET['id']) { ?>
            / <a href="wisata" class="text-decoration-none text-dark">Wisata</a>
          <?php }
          if ($_SESSION['page-url'] == "edit-wisata?id=" . $_GET['id']) { ?>
            / <a href="wisata" class="text-decoration-none text-dark">Wisata</a>
          <?php }
    ...
    <ul class="navbar-nav ms-auto">
      <?php if ($_SESSION['page-url'] != "./" && $_SESSION['page-url'] != "profil" && $_SESSION['page-url'] != "lokasi?id=" . $_GET['id'] && $_SESSION['page-url'] != "galeri?id=" . $_GET['id'] && $_SESSION['page-url'] != "edit-wisata?id=" . $_GET['id']) { ?>
        <li class="nav-item">
